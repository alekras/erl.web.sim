	...
	[ 
		{ setup, 
			...
			{inorder, [
				...
				{"rest service", fun sim_restful:get_session_b/0},
				{"rest service", fun sim_restful:get_login/0},
				{"rest service", fun sim_restful:get_session_a/0},
				{"rest service", fun sim_restful:post_add_contact/0},
				{"rest service", fun sim_restful:get_all_contacts/0},
				{"rest service", fun sim_restful:delete_contact/0},
				{foreachx, 
