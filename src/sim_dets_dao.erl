...
start() ->
	DB_Folder = application:get_env(sim_web, dets_home_folder, "dets-storage"),
...
get(User_Id) when is_binary(User_Id) ->
	?MODULE:get(binary_to_list(User_Id));
get(User_Id) when is_list(User_Id) ->
