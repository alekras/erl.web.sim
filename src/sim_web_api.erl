...
validate_response('addUserContact', 200, Body, ValidatorState) ->
    validate_response_body('Contacts', 'Contacts', Body, ValidatorState);
validate_response('addUserContact', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('addUserContact', 404, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('deleteUserContact', 200, Body, ValidatorState) ->
    validate_response_body('Contacts', 'Contacts', Body, ValidatorState);
validate_response('deleteUserContact', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('deleteUserContact', 404, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
...
validate_response('getSession', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getUserContacts', 200, Body, ValidatorState) ->
    validate_response_body('Contacts', 'Contacts', Body, ValidatorState);
validate_response('getUserContacts', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('getUserContacts', 404, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
...
validate_response('loginUser', 404, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
validate_response('registerUser', 200, Body, ValidatorState) ->
    validate_response_body('User', 'User', Body, ValidatorState);
validate_response('registerUser', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
...
request_params('addUserContact') ->
    [
        'userName',
        'Contact'
    ];
request_params('deleteUserContact') ->
    [
        'userName',
        'Contact'
    ];
...
request_params('getUserContacts') ->
    [
        'userName'
    ];
...
request_param_info('addUserContact', 'userName') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('addUserContact', 'Contact') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/Contact">>},
            required
        ]
    };
request_param_info('deleteUserContact', 'userName') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('deleteUserContact', 'Contact') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/Contact">>},
...
request_param_info('getUserContacts', 'userName') ->
    #{
        source => binding,
        rules => [
            {type, binary},
...
request_param_info('registerUser', 'UserReq') ->
    #{
        source => body,
        rules => [
            {schema, object, <<"#/components/schemas/UserReq">>},
            required
        ]
    };
