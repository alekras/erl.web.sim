...
//    	    	break;
    ...
    var Pinger = function (client, window, keepAliveInterval) {
        ...
        this.isReset = false;
        var pingMsg = new WireMessage(MESSAGE_TYPE.PINGREQ);
        var pingReq = pingMsg.encode();
...
//                this._client._schedule_message(pingMsg);
...
console.log(">>> ClientImpl.disconnect");
        if (!this.socket)
...
//        this.receivePinger = new Pinger(this, window, this.connectOptions.keepAliveInterval);
        this.connectOptions.keepAliveInterval += 5; 
    ...
    ClientImpl.prototype._on_socket_message = function (event) {
        ...
        this.sendPinger.reset();//        this.receivePinger.reset();
